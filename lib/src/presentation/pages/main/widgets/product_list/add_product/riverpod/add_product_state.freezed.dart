...
class _$AddProductStateImpl extends _AddProductState {
  ...
  @override
  String toString() {
    return 'AddProductState(isLoading: $isLoading, isReviewing: $isReviewing, initialStocks: $initialStocks, selectedIndexes: $selectedIndexes, stockCount: $stockCount, product: $product, selectedStock: $selectedStock)';
  }
